...
CREATE VIEW IF NOT EXISTS top_level_dashboard AS
  WITH
      _most_recent_version_status AS (SELECT
                                        o.id                 org_id,
                                        o.org_name,
                                        s.id                 study_id,
                                        s.study_name,
